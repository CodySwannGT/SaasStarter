...
const UIAccessibleAlertDialog = createAlertDialog({
  Root:
    Platform.OS === "web"
      ? (withStyleContext(View, SCOPE) as React.ComponentType<unknown>)
      : (withStyleContextAndStates(
          View,
          SCOPE
        ) as React.ComponentType<unknown>),
  Body: ScrollView,
  Content: Motion.View as React.ComponentType<any>,
  CloseButton: Pressable,
  Header: View,
  Footer: View,
  Backdrop: AnimatedPressable as React.ComponentType<any>,
  AnimatePresence: AnimatePresence,
});

cssInterop(UIAccessibleAlertDialog, { className: "style" as any });
